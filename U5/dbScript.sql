...
INSERT INTO `OperationDoge`.`DogCourse` (`CourseName`, `CourseTeacher`, `CourseDate`, `AgeOfDog`, `Gender`, `PriorKnowledge`, `CourseText`) VALUES ('Patrullhund', 'Batman', '2016-02-01', '6', 'M', 'Kommunikation med hunden', 'På uppdrag av Armén/Hemvärnet, Flygvapnet och Marinen kan ni utbilda er inom Brukshundklubben till patrullhund och förare. Du placeras i något av Försvarsmaktens olika förband.');

INSERT INTO `OperationDoge`.`Participant` (`DogName`,`OwnerName`,`Email`,`AgeOfDog`,`Gender`,`DogCourse_CourseName`,`DogCourse_CourseTeacher`,`DogCourse_CourseDate`,`RegisterDate`) VALUES ('Rudi','Janne','janne@janne.se','2','F','Kommunikation med hunden','Sven-Göran','2016-02-01','2016-01-01');
INSERT INTO `OperationDoge`.`Participant` (`DogName`,`OwnerName`,`Email`,`AgeOfDog`,`Gender`,`DogCourse_CourseName`,`DogCourse_CourseTeacher`,`DogCourse_CourseDate`,`RegisterDate`) VALUES ('Ulli','Janne','janne@janne.se','3','F','Kommunikation med hunden','Sven-Göran','2016-02-01','2016-01-01');
INSERT INTO `OperationDoge`.`Participant` (`DogName`,`OwnerName`,`Email`,`AgeOfDog`,`Gender`,`DogCourse_CourseName`,`DogCourse_CourseTeacher`,`DogCourse_CourseDate`,`RegisterDate`) VALUES ('Sissi','Mange','mange@ma.se','2','F','Kommunikation med hunden','Sven-Göran','2016-02-01','2016-01-01');
INSERT INTO `OperationDoge`.`Participant` (`DogName`,`OwnerName`,`Email`,`AgeOfDog`,`Gender`,`DogCourse_CourseName`,`DogCourse_CourseTeacher`,`DogCourse_CourseDate`,`RegisterDate`) VALUES ('Rudi','Janne','janne@janne.se','7','M','Patrullhund','Batman','2016-02-01','2016-01-01');
INSERT INTO `OperationDoge`.`Participant` (`DogName`,`OwnerName`,`Email`,`AgeOfDog`,`Gender`,`DogCourse_CourseName`,`DogCourse_CourseTeacher`,`DogCourse_CourseDate`,`RegisterDate`) VALUES ('Ivar','Kanne','ivae@asd.se','7','M','Patrullhund','Batman','2016-02-01','2016-01-02');
INSERT INTO `OperationDoge`.`Participant` (`DogName`,`OwnerName`,`Email`,`AgeOfDog`,`Gender`,`DogCourse_CourseName`,`DogCourse_CourseTeacher`,`DogCourse_CourseDate`,`RegisterDate`) VALUES ('Upi','Lann','dsadsa@fdsfs.se','7','M','Patrullhund','Batman','2016-02-01','2016-01-03');
INSERT INTO `OperationDoge`.`Participant` (`DogName`,`OwnerName`,`Email`,`AgeOfDog`,`Gender`,`DogCourse_CourseName`,`DogCourse_CourseTeacher`,`DogCourse_CourseDate`,`RegisterDate`) VALUES ('Supo','Sanne','dsa@fdsfsd.se','7','M','Patrullhund','Batman','2016-02-01','2016-01-04');
INSERT INTO `OperationDoge`.`Participant` (`DogName`,`OwnerName`,`Email`,`AgeOfDog`,`Gender`,`DogCourse_CourseName`,`DogCourse_CourseTeacher`,`DogCourse_CourseDate`,`RegisterDate`) VALUES ('Kaj','Rörjan','dsa@fdsfs.se','7','M','Patrullhund','Batman','2016-02-01','2016-01-04');
INSERT INTO `OperationDoge`.`Participant` (`DogName`,`OwnerName`,`Email`,`AgeOfDog`,`Gender`,`DogCourse_CourseName`,`DogCourse_CourseTeacher`,`DogCourse_CourseDate`,`RegisterDate`) VALUES ('Sven','Bosse','gsdgds@fdsf.se','7','M','Patrullhund','Batman','2016-02-01','2016-01-05');
INSERT INTO `OperationDoge`.`Participant` (`DogName`,`OwnerName`,`Email`,`AgeOfDog`,`Gender`,`DogCourse_CourseName`,`DogCourse_CourseTeacher`,`DogCourse_CourseDate`,`RegisterDate`) VALUES ('Jopp','Bo','gdsfdsf@fdsdf.se','7','M','Patrullhund','Batman','2016-02-01','2016-01-06');
INSERT INTO `OperationDoge`.`Participant` (`DogName`,`OwnerName`,`Email`,`AgeOfDog`,`Gender`,`DogCourse_CourseName`,`DogCourse_CourseTeacher`,`DogCourse_CourseDate`,`RegisterDate`) VALUES ('Sopp','Mange','fdsfds@sdfsd.se','7','M','Patrullhund','Batman','2016-02-01','2016-01-07');
INSERT INTO `OperationDoge`.`Participant` (`DogName`,`OwnerName`,`Email`,`AgeOfDog`,`Gender`,`DogCourse_CourseName`,`DogCourse_CourseTeacher`,`DogCourse_CourseDate`,`RegisterDate`) VALUES ('Kopp','Harald','fds@sdfsd.se','7','M','Patrullhund','Batman','2016-02-01','2016-01-08');
INSERT INTO `OperationDoge`.`Participant` (`DogName`,`OwnerName`,`Email`,`AgeOfDog`,`Gender`,`DogCourse_CourseName`,`DogCourse_CourseTeacher`,`DogCourse_CourseDate`,`RegisterDate`) VALUES ('Mopp','Sven','fds@fdssdf.se','7','M','Patrullhund','Batman','2016-02-01','2016-01-09');
...
INSERT INTO `OperationDoge`.`MyDog` (`OfficialName`, `Name`, `Birthdate`, `Description`, `Color`, `Height`, `Weight`) VALUES (' Batuulis Peak Performance', 'Diva', '2007-07-27','Hon är söt och ofta pigg','Brun','145','65');

INSERT INTO `OperationDoge`.`NewsFeed` (`NewsTitle`,`CreatedAt`,`Description`,`NewsLink`) VALUES ('Vi finns på Facebook!','2016-02-01','Vi finns nu på facebook, in och like:a!!','http://facebook.com');
INSERT INTO `OperationDoge`.`NewsFeed` (`NewsTitle`,`CreatedAt`,`Description`,`NewsLink`) VALUES ('In och besök jannes sida!','2016-02-02','Janne finns på instagram, in och följ!','http://instagram.com');
INSERT INTO `OperationDoge`.`NewsFeed` (`NewsTitle`,`CreatedAt`,`Description`,`NewsLink`) VALUES ('Mästare igen!! Kolla facebook!','2016-02-03','Kolla bilderna på facebook! Vi är mästare igen!','http://facebook.com');

INSERT INTO `OperationDoge`.`News` (`Title`,`CreatedAt`,`NewsText`) VALUES ('Ny site uppe','2015-05-14','Välkommen till vår nya site. Utvecklad av tre drivna studenter på Informatik i Lund. Klicka runt på sidan och se alla nya funktioner. Åter välkommen!');
INSERT INTO `OperationDoge`.`News` (`Title`,`CreatedAt`,`NewsText`) VALUES ('Välkommen till Batuulius','2015-05-16','Batuulis kennel bedriver en liten och engagerad uppfödning av Rhodesian Ridgeback i Hindås utanför Göteborg. Min ambition är att föda upp sunda, trevliga & rastypiska hundar, som framför allt ska fungera som familjemedlemmar i sina nya hem. Funderar ni på att skaffa en Rhodesian Ridgeback, så är du hjärtligt välkommen att höra av dig till mig med dina frågor eller för allmänt "hundprat".');
INSERT INTO `OperationDoge`.`News` (`Title`,`CreatedAt`,`NewsText`) VALUES ('Ny Svensk Champion','2015-05-17','Jag är så glad och stolt värdesätter detta oerhört mycket då det visar prov på att det finns arbetslust och en hjärna som klarar av att arbeta !!!!! Ett jättegrattis Linda som har tränat Aiko fram till detta;)');

INSERT INTO `OperationDoge`.`GuestbookThread` (`Title`,`CreatedAt`,`Username`,`Description`) VALUES ('Tappar era hundar också pälsen?','2015-05-14','Olle','Jag undrar om era hundar också tappar pälsen?');
INSERT INTO `OperationDoge`.`GuestbookThread` (`Title`,`CreatedAt`,`Username`,`Description`) VALUES ('Bortsprungen hund.','2015-05-15','Janne','Min hund sprang iväg från mig häromdagen. Har ni sett honom?');
INSERT INTO `OperationDoge`.`GuestbookThread` (`Title`,`CreatedAt`,`Username`,`Description`) VALUES ('Tävling på Lördag','2015-05-16','Ulla','Agility för brukshundar imorgon på hötorget, alla är välkommna.');

INSERT INTO `OperationDoge`.`Post` (`Username`,`CreatedAt`,`PostText`,`Thread_Title`,`Thread_CreatedAt`) VALUES ('Olle','2015-05-15','Varför svara ingen mig?? Är det så ovanligt?','Tappar era hundar också pälsen?','2015-05-14');
INSERT INTO `OperationDoge`.`Post` (`Username`,`CreatedAt`,`PostText`,`Thread_Title`,`Thread_CreatedAt`) VALUES ('Janne','2015-05-16','Nej, min hund tappar ingen päls','Tappar era hundar också pälsen?','2015-05-14');
INSERT INTO `OperationDoge`.`Post` (`Username`,`CreatedAt`,`PostText`,`Thread_Title`,`Thread_CreatedAt`) VALUES ('Yngve','2015-05-16','Nej jag har inte sett den.','Bortsprungen hund.','2015-05-15');
INSERT INTO `OperationDoge`.`Post` (`Username`,`CreatedAt`,`PostText`,`Thread_Title`,`Thread_CreatedAt`) VALUES ('Olle','2015-05-17','Jag och rudolf kommer! Var skriver man upp sig?','Tävling på Lördag','2015-05-16');
